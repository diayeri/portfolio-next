...
export const projectsData: ProjectsData[] = [
  ...
  },
  {
    ...
    startDate: "2023.03",
    endDate: "2024.05",
    category: ["Markup", "Responsive Design"],
    role: "Web Publishing 100%, Responsive Design 80%",
    tech: ["React", "TypeScript", "Tailwind", "Storybook"],
    tag: ["Markup", "UX/UI", "DeFi", "Blockchain", "ResponsiveDesign"],
    client: "Quarkonix",
    clientType: "company",
    featured: {
      order: 3,
  ...
  },
  {
    ...
    role: "Web Design 100%, Markup 100%",
